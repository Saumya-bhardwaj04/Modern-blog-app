...
function Setting() {
  ...
  return token == null ? (
    ...
    <div className="pt-[72px] min-h-screen w-full">
      <div className="min-h-[calc(100vh-72px)] flex justify-center">
        <div className="w-full md:w-[800px] p-5 flex flex-col justify-center md:-translate-y-6">
